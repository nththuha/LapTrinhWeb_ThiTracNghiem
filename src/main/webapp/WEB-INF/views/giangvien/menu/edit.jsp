...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<label class="font-weight-bold">THÊM/XÓA/SỬA GIẢNG VIÊN</label>
		</div>
		<div class="card-header">
			<form:form class="row g-3" modelAttribute="giangVien"
				action="http://localhost:8080/QLTTN/edit.htm">
				<div class="col-md-2">
					<label class="font-weight-bold">Mã giảng viên</label>
					<form:input path="maGV" type="text" class="form-control"
						id="exampleFormControlInput1" placeholder="Nhập mã giảng viên" />
					<form:errors path="maGV"></form:errors>	
				</div>
				<div class="col-md-2">
					<label class="font-weight-bold">Họ</label>
					<form:input path="ho" type="text" class="form-control"
						id="exampleFormControlInput1" placeholder="Nhập họ giảng viên" />
					<form:errors path="ho"></form:errors>		
				</div>
				<div class="col-md-2">
					<label class="font-weight-bold">Tên</label>
					<form:input path="ten" type="text" class="form-control"
						id="exampleFormControlInput1" placeholder="Nhập tên giảng viên" />
				...
				<div class="form-inline col-5">
					...
					<form class="form-inline">
						<input name="searchInput" id="searchInput" style="outline: 1px solid green;" class="form-control"
							type="search" placeholder="Tìm giảng viên" aria-label="Search">
						<div class="col-md-2">
	...
	<div class="card">
		<div class="card-header">
			<label class="font-weight-bold">DANH SÁCH GIẢNG VIÊN</label>
		...
		<div class="card-header">
			...
			<table class="table">
				...
				<tbody>
					<c:forEach var="gv" items="${pagedListHolder.pageList}">
						<tr class="table-light">
							<td>${gv.ho}</td>
							<td>${gv.ten}</td>
							<td>${gv.email}</td>
							<td><a
								href="http://localhost:8080/QLTTN/edit/${gv.maGV}.htm?linkEdit"><img
									width="46" height="36"
									src="<c:url value='/resources/img/edit.png'/>" /></a></td>
							<td><a name="btnDelete"
								href="http://localhost:8080/QLTTN/edit/${gv.maGV}.htm?linkDelete"
