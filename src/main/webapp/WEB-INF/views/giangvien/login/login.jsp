					...
					<div class="card-body p-0">
						...
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block bg-login-image"
								...
								<img src="resources/img/dangnhap.jpg" />
							</div>
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form:form method="post" action="quanly.htm" commandName="giangVien">
										<div class="form-group">
											<form:input path="maGV" type="text"
												class="form-control form-control-user"
												id="exampleInputEmail" placeholder="Nhập mã giảng viên"/>
										</div>
										<div class="form-group">
									...
									<hr>
									<div class="text-center">
										<a class="small" href="matkhau.htm">Quên mật
											khẩu?</a>
									</div>
									<div class="text-center">
										<a class="small" href="sinhvien.htm">Đi đến trang của sinh viên</a>
									</div>
								</div>
							</div>
						</div>
